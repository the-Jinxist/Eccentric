...
void main(){
    ...
    app = MaterialApp(
      home: Scaffold(
          body: Builder(builder: (BuildContext context) {
            ...
            return GameView(result: testResult, onSavedTap: (){},);
          })
      ),
    );
  ...
  group("Game view tests", (){
    ...
    testWidgets("Test to make rates text is correct", (WidgetTester tester) async {

      //runAsync is used to make sure the http connection doesn't fail the test
      await tester.runAsync(() async {
        await tester.pumpWidget(app);

        final Finder textFinder = find.text("Rates: 25");
        expect(textFinder, findsOneWidget);
      });
